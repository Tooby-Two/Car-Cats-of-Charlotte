$(document).ready(function () {
    ...
    const characters = ['Gruff','Cherry','Vaporwavezz','Ignis','SolarFlare', 'Hunter','Lajoie','SVK','ET', 'Interstellar', 'Nolan','Roy','Moonie', 'Heim','Reddick', 'Bubba', 'Creed', 'Jeffery', 'Raiden', 'Magma', 'Willow', 'Arthur']; // List of character names
